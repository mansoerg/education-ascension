  ...
  return (
    <div className="flex min-h-[70vh] items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h1 className="display-serif text-5xl text-foreground">Page not found</h1>
...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Education Moving Up" },
      { property: "og:site_name", content: "Education Moving Up" },
